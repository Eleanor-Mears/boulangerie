<div id="main-content">
            <div class="slideshow-container">
                ...
                <div class="slideshow">
                    ...
                    <a href="#article-1"><img id="slider-icon" src="public/images/icons/white-arrow.png"></a>
                    <img class="mySlides cover animate-right" src="public/images/photos/other/croissants-4077812.jpg">
                    <img class="mySlides cover animate-right" src="public/images/photos/other/boulangerie-1868925_1280.jpg">
                    <img class="mySlides cover animate-right" src="public/images/photos/other/pate-943245_1280.jpg">
                    <img class="mySlides cover animate-right" src="public/images/photos/other/boulanger-1868396_1280.jpg">
                </div>
            </div>
                ...
                <div class="main-articles">
                    <article class="article article-1">
                        ...
                        <div class="image-section">
                            <img class="article-image" src="public/images/photos/other/cinnamon-rolls-1417494_1280.jpg" alt="cinnamon rolls" />
                        </div>
                    </article>
                    <article class="article article-2">
                        ...
                        <div class="image-section">
                            <img class="article-image" src="public/images/photos/other/coffee-4334647_1280.jpg" alt="coffee" />
                        </div>
                    </article>
                    <article class="article article-3">
                        ...
                        <div class="image-section">
                            <img class="article-image" src="public/images/photos/other/egg-1836411_1280.jpg" alt="Boulangerie" />
                        </div>
                    </article>
